...
<body class="index-page">
  ...
  <main class="main">
      ...
      <div class="container">
        <div class="row justify-content-center" data-aos="zoom-out">
          <div class="col-xl-7 col-lg-9">
            <div class="bg-white p-4 p-md-5 rounded shadow text-center">
              <!-- Title -->
              <h1>🎉 Selamat!</h1>

              <!-- Description -->
              <p>
                Hasil <strong>SPAN-PTKIN 2026</strong> telah diumumkan.<br>
                Bagi yang dinyatakan <strong>LULUS</strong>, silakan segera melakukan <strong>DAFTAR ULANG</strong>.<br>
                <small>Belum mendaftar? Pilih jalur lain di bawah.</small>
              </p>

              <!-- Tombol Utama -->
              <div class="text-center" data-aos="zoom-out" data-aos-delay="100">
                <a href="https://sia.iainkendari.ac.id/login" target="_blank" class="btn-get-started shake-btn me-2">
          ...
          <!-- Quick Akses Jalur Lain -->
          <div class="row justify-content-center mt-4" data-aos="fade-up" data-aos-delay="200">
            <div class="col-lg-8 text-center">

              <p class="mb-2 text-white">Atau pilih untuk informasi jalur pendaftaran lainnya:</p>

              <a href="#s1" class="btn btn-sm btn-outline-light me-2">
                🎓 Sarjana (S1)
              </a>

              <a href="#s2" class="btn btn-sm btn-outline-light">
                🎓 Pascasarjana (S2)
              </a>
        ...
        <!-- Info Box (tetap dipertahankan biar tidak kosong) -->
        <div class="row gy-4 mt-5">
          ...
          <div class="col-md-6 col-lg-3" data-aos="zoom-out" data-aos-delay="100">
            <div class="icon-box text-center">
              ...
              <h4 class="title">
                Satu-satunya Perguruan Tinggi Keagamaan Negeri di Sulawesi Tenggara
              </h4>
            </div>
          </div>
          ...
          <div class="col-md-6 col-lg-3" data-aos="zoom-out" data-aos-delay="200">
            <div class="icon-box text-center">
              ...
              <h4 class="title">
                UKT terjangkau mulai 400.000 - 2.600.000 (S1)
              </h4>
            </div>
          </div>
          ...
          <div class="col-md-6 col-lg-3" data-aos="zoom-out" data-aos-delay="300">
            <div class="icon-box text-center">
              ...
              <h4 class="title">
                Banyak pilihan program studi keagamaan & umum
              </h4>
            </div>
          </div>
          ...
          <div class="col-md-6 col-lg-3" data-aos="zoom-out" data-aos-delay="400">
            <div class="icon-box text-center">
              ...
              <h4 class="title">
                Kampus berbasis teknologi & inovasi
              </h4>
            </div>
          </div>
        ...
        <div class="row gy-4">
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
            <div class="service-item position-relative">
              ...
              <a class="btn btn-warning mt-2 btn-sm shake-btn" target="_blank"
                href="https://sia.iainkendari.ac.id/login"><i class="bi bi-check-circle"></i>
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
            <div class="service-item position-relative">
              ...
              <p class="mb-1">
                <strong>Status:</strong>
                <span class="text-success">Terbuka Tanggal 13 April 2026</span>
                <!-- atau gunakan text-danger untuk "Tertutup" -->
              </p>
    ...
    <section id="s2" class="services section light-background">
      ...
      <!-- Section Title -->
      <div class="container section-title" data-aos="fade-up">
        <h2>JALUR PENDAFTARAN PASCASARJANA S2 dan S3</h2>
        <p></p>
      </div><!-- End Section Title -->
        ...
        <div class="row gy-4">
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
            <div class="service-item position-relative">
              ...
              <h3>Reguler</h3>
              <p>Penerimaan mahasiswa magister dan doktor dengan Sistem Kuliah Reguler.</p>
              <p class="mb-1">
                <strong>Status:</strong>
                <span class="text-danger">Belum ada penerimaan</span> <!-- atau gunakan text-danger untuk "Tertutup" -->
              </p>
